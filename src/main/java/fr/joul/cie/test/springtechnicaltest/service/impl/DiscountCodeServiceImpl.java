...
import fr.joul.cie.test.springtechnicaltest.SpringTechnicalTestApplication;
...
public class DiscountCodeServiceImpl implements DiscountCodeService {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(DiscountCodeService.class);
    ...
    public boolean discountCodeExists(String discountCode) throws IOException {
        ...
        // Then we check if the code is in the list
